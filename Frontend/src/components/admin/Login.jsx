...
const Login = () => {
    ...
    return (
        <>
                    ...
                    <form action="/admin/login" method="POST" onSubmit={handleonsubmit}>
                        ...
                        <div className="mb-4">
                            ...
                            <input type="text" id="username" name="username"
                                ...
                                placeholder="Enter your username" value={logindata.username} onChange={handleonchange} required />
                        </div>
                        ...
                        <div className="mb-6">
                            ...
                            <input type="password" id="password" name="password"
                                className="w-full px-3 py-2 leading-tight text-zinc-200 bg-zinc-700 rounded focus:outline-none focus:bg-zinc-800"
                                placeholder="Enter your password" value={logindata.password} onChange={handleonchange} required />
                        </div>
          ...
          <% } %> */}
                        {/* {
                            error && <div className="mb-4 p-4 text-red-800 bg-red-200 rounded border border-red-300">
                                {error}
                            </div>
                        } */}
